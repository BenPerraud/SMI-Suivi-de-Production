...
function CreateProduction () {
    ...
    /* Fetch pour récupérer les Opérateurs des options dans le form */
    useEffect (() => {
    ...
    return (
        <div className="rowGap20px">
            <h1 className="titleH1">Etape 2 : ajouter une nouvelle production (le PI renseigné n'existe pas)</h1>
            <form className="form" name="form" method="post" encType="multipart/form-data" onSubmit={postProduction}>
                ...
                <label>Commentaires : <input className="formElement widthComments" id="formComments" type="text" name="comments" defaultValue="Pas de commentaires"/></label>
